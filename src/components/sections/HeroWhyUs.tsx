    ...
    <section className="relative overflow-hidden bg-white py-12 lg:py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-16 lg:gap-20 items-center">
          ...
          >
            <div className="absolute  top-0 right-0 w-90 h-80 rounded-2xl overflow-hidden shadow-xl group">
              <img
                src={whyUs1}
            ...
            <motion.div
              ...
              className="absolute bottom-8 right-4 bg-white rounded-2xl shadow-2xl p-4 flex items-center gap-3 border border-slate-100"
            >
              ...
              <div>
                <p className="text-sm font-extrabold text-primary-dark ">25+ Years</p>
                <p className="text-xs text-slate-500 ">Trusted Formulation</p>
              </div>
            </motion.div>
          </motion.div>
