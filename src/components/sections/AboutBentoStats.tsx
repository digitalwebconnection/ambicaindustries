...
function BentoCard({
  ...
  return (
    <div
      className={`group relative overflow-hidden bg-white rounded-lg sm:rounded-xl p-6 sm:p-8 flex flex-col justify-between shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/[0.04] transition-all duration-500 ease-out hover:shadow-[0_20px_45px_-10px_rgba(4,40,84,0.4)] hover:-translate-y-1.5  ${className}`}
    >
    ...
    <section className="bg-[#eae5df] py-12 sm:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-4 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4 sm:gap-4 justify-between">
          ...
          <div className="lg:col-span-5 h-full min-h-[340px] sm:min-h-[400px] lg:min-h-full">
            <div className="group relative h-full w-full rounded-md sm:rounded-xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-black/[0.03] ">
              <img
                src={bentoImg}
                ...
                loading="lazy"
              />
              <div className="absolute inset-0 bg-linear-to-t from-[#01142b]/85 via-transparent to-transparent opacity-85 group-hover:opacity-95 transition-opacity duration-300 pointer-events-none" />
